...
@Component({
  selector: 'app-payment-remaining',
  templateUrl: './payment-remaining.component.html',
  styleUrls: ['./payment-remaining.component.scss']
})
export class PaymentRemainingComponent {
  error: any;
