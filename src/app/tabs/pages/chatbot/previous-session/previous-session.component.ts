...
@Component({
  selector: 'app-previous-session',
  templateUrl: './previous-session.component.html',
  styleUrls: ['./previous-session.component.scss']
})
export class PreviousSessionComponent implements OnInit,AfterViewChecked {
  statuses = STATUSES;
  activeUser:any;
  users = USERS;
