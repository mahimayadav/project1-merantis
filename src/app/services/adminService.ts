...
export class AdminService {
    ...
    private getUserName: BehaviorSubject<any> = new BehaviorSubject<any>(null);
    public getUserNameSelect: Observable<any> = this.getUserName.asObservable();
  
    constructor(private http: HttpClient){}
    setName(object:any) {
      this.getUserName.next(object);
    }
    getProductsData() {
        return [
            {
